...
async function doSeed(): Promise<void> {
  ...
  await db.insert(assets).values([
    ...
    { id: assetGitlabId, tenant_id: tenantId, asset_type: 'application', name: 'gitlab-prod', display_name: 'GitLab CE', status: 'active', ip_address: '10.0.5.60', location: 'ESXi Host 02', sla_tier: 'gold', environment: 'production', owner_group_id: devGroupId, customer_id: null, attributes: '{"version": "16.8", "runners": 4, "repos": 67}', created_at: now, updated_at: now, created_by: adminId },
    { id: assetPrometheusId, tenant_id: tenantId, asset_type: 'application', name: 'prometheus-prod', display_name: 'Prometheus Monitoring', status: 'active', ip_address: '10.0.5.60', location: 'ESXi Host 02', sla_tier: 'gold', environment: 'production', owner_group_id: opsGroupId, customer_id: null, attributes: '{"version": "2.49", "targets": 142, "retention_days": 30}', created_at: now, updated_at: now, created_by: adminId },
    ...
    { id: assetCiCdId, tenant_id: tenantId, asset_type: 'application', name: 'jenkins-prod', display_name: 'Jenkins CI/CD', status: 'active', ip_address: '10.0.5.60', location: 'ESXi Host 02', sla_tier: 'silver', environment: 'production', owner_group_id: devGroupId, customer_id: null, attributes: '{"version": "2.440", "agents": 8, "pipelines": 34}', created_at: now, updated_at: now, created_by: managerId },
  ...
  await db.insert(assets).values([
    ...
    { id: assetSiemId, tenant_id: tenantId, asset_type: 'application', name: 'siem-splunk-01', display_name: 'Splunk SIEM', status: 'active', ip_address: '10.0.5.60', location: 'Serverraum A, Rack 03', environment: 'production', attributes: JSON.stringify({ vendor: 'Splunk', version: '9.2.0', function: 'SIEM', daily_ingestion_gb: 50, retention_days: 365, agents: 42 }), created_at: daysAgo(300), updated_at: daysAgo(2), created_by: adminId },
