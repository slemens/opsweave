...
const CapacityDetailPage = lazy(() => import('@/pages/CapacityDetailPage'));
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route element={<ProtectedLayout />}>
            ...
            <Route path="/capacity-planning/:assetId" element={<Suspense fallback={<SettingsFallback />}><CapacityDetailPage /></Suspense>} />
